        ...
        {displayedTasks.length === 0 && !showInfeasible ? (
          ...
          displayedTasks.map(task => (
            ...
            >
              ...
              >
                {task.completed ? <Check size={30} strokeWidth={4} /> : React.cloneElement((NURSING_ICONS[task.category?.toLowerCase()] || NURSING_ICONS['exercise']) as React.ReactElement, { size: 28, strokeWidth: 2.5 })}
              </div>
