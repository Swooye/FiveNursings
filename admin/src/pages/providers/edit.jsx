...
export const ProviderEdit = () => {
    ...
    const providerData = queryResult?.data?.data;

    // Map database fields to Cascader region array on load
    useEffect(() => {
        if (providerData) {
            const { province, city, district } = providerData;
